...
class Settings(BaseSettings):
    ...
    DATA_PERMISSION_MODELS: dict[
        str, str
    ] = {  # Allowed SQLA models for data filtering, must be defined as module string
    ...
    # .env Operation log
    OPERA_LOG_ENCRYPT_SECRET_KEY: str  # Secret key os.urandom(32), must be converted to str using bytes.hex()
    ...
    OPERA_LOG_ENCRYPT_TYPE: int = (
        1  # 0: AES (performance loss); 1: md5; 2: ItsDangerous; 3: no encryption, others: replaced with ******
    )
