...
class Settings(BaseSettings):
    ...
    OPERA_LOG_ENCRYPT_SECRET_KEY: str  # Secret key, generated by os.urandom(32), must be converted to str using bytes.hex()
    ...
    DATA_PERMISSION_COLUMN_EXCLUDE: list[str] = [  # Columns to exclude from data filtering in SQLA models
        'id',
        'sort',
        'del_flag',
        'created_time',
    ...
    TRACE_ID_LOG_UUID_LENGTH: int = 32  # UUID length, must be <= 32
    ...
    OPERA_LOG_ENCRYPT_TYPE: int = 1  # 0: AES (performance loss); 1: md5; 2: ItsDangerous; 3: no encryption, others: replaced with ******
    OPERA_LOG_ENCRYPT_KEY_INCLUDE: list[str] = [  # Keys for encrypted interface input parameters
        'password',
        'old_password',
        'new_password',
        'confirm_password',
    ...
    CAPTCHA_LOGIN_EXPIRE_SECONDS: int = 60 * 5  # 3 minutes
