...
router.include_router(data_rule_router, prefix='/data-rules', tags=['System Data Rule'])
router.include_router(data_scope_router, prefix='/data-scopes', tags=['System Data Scope'])
