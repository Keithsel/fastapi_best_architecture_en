...
@router.get(
    ...
    description='After Google authorization, automatically redirect to the current address and get user info. Automatically create a system user with the user info.',
