...
(8, 'Menu Display', 'sys_menu_display', 1, 'Menu display status', now(), null),
(9, 'Menu Cache', 'sys_menu_cache', 1, 'Menu cache status', now(), null);
...
(18, 'sys_data_rule_expression', 'Include (in)', '6', 7, 1, 'Include expression', 5, now(), null),
(19, 'sys_data_rule_expression', 'Not Include (not in)', '7', 8, 1, 'Not include expression', 5, now(), null),
